...
admin = admin.Admin(app, name='Example: SQLAlchemy', template_mode='bootstrap3',
                    category_icon_classes={'Other': 'glyphicon glyphicon-wrench'})
...
admin.add_sub_category(name="Language", parent_name="Other")
admin.add_link((MenuLink(name='English', url='/admin?lang=en', category='Language')))
admin.add_link((MenuLink(name='简体中文', url='/admin?lang=zh_CN', category='Language')))
admin.add_link((MenuLink(name='繁體中文', url='/admin?lang=zh_TW', category='Language')))
